export default {
  ...
  'providers.form.customBaseUrlAnthropicDesc': 'Anthropic 格式请求的专用地址。不填则使用 Base URL。',
  'providers.form.supportedFormats': '支持的协议格式',
  'providers.form.supportedFormatsDesc': '选择该供应商支持的原生 API 格式，不支持的格式将自动转换。',
