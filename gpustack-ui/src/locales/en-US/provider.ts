export default {
  ...
  'providers.form.customBaseUrl': 'Base URL',
  'providers.form.customBaseUrlAnthropic': 'Anthropic Base URL',
  'providers.form.customBaseUrlAnthropicDesc': 'Dedicated URL for Anthropic format requests. Falls back to Base URL if not set.',
  'providers.form.supportedFormats': 'Supported Formats',
  'providers.form.supportedFormatsDesc': 'Select the native API formats supported by this provider. Unsupported formats will be auto-converted.',
